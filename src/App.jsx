...
const Agency = React.lazy(() => 
  import("./components/Agency/Agency.jsx")
);

const Careers = React.lazy(() => 
  import("./components/Careers/Careers.jsx")
);
...
const MoreInfo = React.lazy(() => 
  import("./components/MoreInfo/MoreInfo.jsx")
);
...
const StartPage = React.lazy(() => 
  import("./StartPage.jsx")
);

const IMS = React.lazy(() => 
  import("./IMS.jsx")
);

import "./styles/globals.css";
import "./styles/fallback-loader.css";
...
import "./styles/featured-videos.css";
