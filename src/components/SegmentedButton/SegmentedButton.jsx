    ...
    return (
        <div className="segmented-button-container">
            <div className="segmented-button-group">
                <button className={`segmented-button ${selected === 'medical' ? 'selected' : ''}`} onClick={() => handleClick('medical')}>
                    Medical
                </button>
                <button className={`segmented-button ${selected === 'administrative' ? 'selected' : ''}`} onClick={() => handleClick('administrative')}>
                    Administrative
                </button>
            </div>
