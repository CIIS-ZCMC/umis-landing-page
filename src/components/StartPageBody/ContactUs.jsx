    ...
    <div className="contact-us contact-us-sm">
      ...
      <div className="contact-us-body contact-us-body-sm">
        <div className="contact-us-heading contact-us-heading-sm">
          ...
          <Paragraph
            text="Office of the Medical Center Chief"
        ...
        <div className="contact-us-details contact-us-details-sm">
          <span className="contact-us-details-container contact-us-details-container-sm">
            <Paragraph
              text="Email:"
              className="contact-us-label contact-us-label-sm"
            />
            <Link
              to="mailto:innovations@zcmc.doh.gov.ph"
              className="email contact-us-content contact-us-content-sm"
          ...
          <span className="contact-us-details-container contact-us-details-container-sm">
            ...
            <Paragraph
              text="ext 276 or 262"
              className="contact-us-content contact-us-content-sm"
            />
          </span>
        </div>
        ...
        <div className="contact-us-report contact-us-report-sm">
          <Paragraph
            text="Report an issue on:"
            className="contact-us-report-label contact-us-report-label-sm"
          />
          <Link
            to="https://forms.google/report-an-issue/"
            className="contact-us-link contact-us-link-sm"
            rel="noopener noreferrer"
          >
