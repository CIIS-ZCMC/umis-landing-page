          ...
          <div class="row">
            <div class="card">
              ...
              <div class="card-content">
                <div class="card-heading">
                  ...
                  <p class="description">
                    Enroll patients being discharged who require continued medication and monitoring at home
                    to accurately collect and record information.
                  </p>
                </div>
            ...
            <div class="card">
              ...
              <div class="card-content">
                <div class="card-heading">
                  <p class="title">
                    Hemodialysis notification form
                  </p>
                  <p class="description">
                    Submit a hemodialysis notification form for patients who require hemodialysis,
                    which are subject to be scheduled if condition warrants.
                  </p>
                </div>
                <a href="" class="link-with-trailing-icon" rel="noopener noreferrer">
                  Open form
                  <img src={cardIcon} alt="" />
                </a>
              </div>
            ...
            <div class="card">
              ...
              <div class="card-content">
                ...
                <p class="link-with-trailing-icon-disabled">
                  Coming soon
                </p>
              </div>
            </div>
          ...
          <div class="row">
            <div class="card feedback-card">
              <div class="feedback-heading">
                <p class="feedback-title">
                  Have any concerns with UMIS?
                </p>
                <p class="description">
                  Your feedback will help us on improving your overall experiences.
                </p>
              </div>
              <a href="" class="link-with-trailing-icon" rel="noopener noreferrer">
                Report an issue
            ...
            <div class="card feedback-card">
              <div class="feedback-heading">
                ...
                <p class="description">
                  Our friendly team is here to help you. You may call us via telephone.
                </p>
              </div>
              <a href="tel:262" class="link-with-trailing-icon" rel="noopener noreferrer">
                IISU local - (262)
