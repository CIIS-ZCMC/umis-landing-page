      ...
      <div className="div account-used-container-sm">
        <div className="account-used account-used-sm">
          ...
          <div className="user user-sm">
            <Paragraph text="Rodel Delos Santos MD" className="account-name account-name-sm" />
        ...
        <Link to="/" className="secondary-CTA account-used-CTA-sm" rel="noopener noreferrer">
          Logout
        </Link>
      </div>
    </header>
