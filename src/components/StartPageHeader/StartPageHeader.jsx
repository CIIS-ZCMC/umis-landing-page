...
const StartPageHeader = () => {
  return (
    <header className="start-page-header">
      ...
      <div class="div account-used-container-sm">
        <div class="account-used account-used-sm">
