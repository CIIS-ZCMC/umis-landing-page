            ...
            {isOpen && (
                <div className="mega-menu-container-3">
                    <div className="mega-menu-heading">
                        ...
                        <Paragraph text="See all fees included on certain services." className="mega-menu-description" />
                    </div>
                    <div className="mega-menu-content">
                        ...
                        <div className="mega-menu-right">
                            <Paragraph text="Common rates and fees" className="mega-menu-label" />
                            <hr id="mega-menu-divider" />
