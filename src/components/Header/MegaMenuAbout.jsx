...
const AboutMegaMenu = () => {
    ...
    return (
        <>
            <div className="header-link-2 mega-menu" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
            ...
            <div className="header-link-2-sm mega-menu-sm" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
